...
import { MAIN_API, ROUTE_GET_PRODUCTS, ROUTE_SEND_OFFER, ROUTE_GET_TRANSACTIONS } from '../config/api_routes'
...
export const getTransactions = async () => {
    return await fetch(MAIN_API.length !== 0 ? 
        MAIN_API.concat(ROUTE_GET_TRANSACTIONS) : `https://reqres.in/api/unknown/23`, {
        method: 'GET',
        redirect: "follow",
        headers: {
            'Content-Type': 'application/json',
