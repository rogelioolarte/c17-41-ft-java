      ...
      <Formik initialValues={initialValues} onSubmit={handleSubmit} validationSchema={userSchema} >
        <Form className="register-form">
          ...
          <div className="login-register-input">
            ...
            <Field type="text" id="first-name" name="firstName" className="register-field" autoFocus />
            <ErrorMessage name="firstName" component="div" className="error-message" />
          </div>

          <div className="login-register-input">
            <label htmlFor="last-name">Last Name</label>
            <Field type="text" id="last-name" name="lastName" className="register-field" />
            <ErrorMessage name="lastName" component="div" className="error-message" />
          </div>

          <div className="login-register-input">
            <label htmlFor="id-passport">ID or Passport No.</label>
            <Field type="text" id="id-passport" name="idPassport" className="register-field" />
            <ErrorMessage name="idPassport" component="div" className="error-message" />
          </div>
          ...
          <div className="login-register-input">
            ...
            <ErrorMessage name="account" component="div" className="error-message" />
          </div>
          ...
          <div>
            <p className="navigation-link">Already have an account?{" "}
