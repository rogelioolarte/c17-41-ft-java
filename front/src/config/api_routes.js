...
export const ROUTE_BUY_CRYPTO= '/api/transactions/buy';
export const ROUTE_RECHARGE_WALLET= '/api/user/wallet/';
export const ROUTE_GET_TRANSACTIONS = '/api/transactions/'